...
<div class="column c-action">操作</div>
    ...
    <div class="item-list" ectype="itemList">
    	...
    	<?php if(is_array($cartGoodsRes) || $cartGoodsRes instanceof \think\Collection || $cartGoodsRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cartGoodsRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <!-- 循环 -->
...
<div class="cart-checkbox" ectype="ckList">
    <input type="checkbox" id="checkItem_<?php echo $vo['goods_id_attr_id']; ?>" value="<?php echo $vo['goods_id_attr_id']; ?>" name="checkItem" class="ui-checkbox" ectype="ckGoods">
    <label for="checkItem_<?php echo $vo['goods_id_attr_id']; ?>" class="ui-label-14">&nbsp;</label>
</div>
                    </div>
                    <div class="cell s-goods">
<div class="goods-item">
    <div class="p-img">
                <a href="#" target="_blank"><img src="__uploads__/<?php echo $vo['sm_thumb']; ?>" width="70" height="70"></a>
            </div>
    <div class="item-msg">
    	        <a href="#" target="_blank"><?php echo $vo['goods_name']; ?></a>
                <div class="gds-types">
        </div>
    </div>
</div>
                    ...
                    <div class="cell s-props">
                    	<?php echo $vo['goodsStr']; ?>
                    </div>
                    <div class="cell s-price">
<strong id="goods_price_8"><em>¥</em><?php echo $vo['shop_price']; ?></strong>
                    </div>
...
<strong id="goods_subtotal_8"><font id="_8_subtotal"><em>¥</em><?php echo $vo['number']*$vo['shop_price']; ?></font></strong>
...
<a href="#" id="remove_8" ectype="cartOperation" data-value="{&quot;divId&quot;:&quot;cart_remove&quot;,&quot;url&quot;:&quot;<?php echo url('index/Flow/dropGoods',array('id_attr'=>$vo['goods_id_attr_id']),''); ?>&quot;,&quot;cancelUrl&quot;:&quot;flow.php?step=drop_to_collect&amp;id=8&quot;,&quot;recid&quot;:8,&quot;title&quot;:&quot;删除&quot;}" class="cart-remove">删除</a>
<a href="#" id="store_8" ectype="cartOperation" data-value="{&quot;divId&quot;:&quot;cart_collect&quot;,&quot;url&quot;:&quot;flow.php?step=drop_to_collect&amp;id=8&quot;,&quot;recid&quot;:8,&quot;title&quot;:&quot;关注&quot;}" class="cart-store">收藏</a>
    ...
    <div class="cart-checkbox cart-all-checkbox" ectype="ckList">
	    ...
	    <div class="operation">
        <a href="#" class="cart-remove-batch" data-dialog="remove_collect_dialog" data-divid="cart-remove-batch" data-removeurl="<?php echo url('index/Flow/deleteCartGoods'); ?>" data-collecturl="ajax_dialog.php?act=drop_to_collect" data-title="删除">删除选中的商品</a>
