<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/admin\view\order\ordergoods.htm";i:1561085682;s:80:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/admin\view\common\top.htm";i:1508129371;s:81:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/admin\view\common\left.htm";i:1561206852;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                     ...
                     <li>
                        <a href="<?php echo url('admin/Order/lst'); ?>">订单列表</a>
                    </li>
...
<!-- <button type="button" tooltip="添加订单" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = ''"> <i class="fa fa-plus"></i> Add
</button> -->
<div class="row">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if(is_array($GoodsArr) || $GoodsArr instanceof \think\Collection || $GoodsArr instanceof \think\Paginator): $i = 0; $__LIST__ = $GoodsArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$orderGoods): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td align="center"><?php echo $orderGoods['markte_price']; ?></td>
