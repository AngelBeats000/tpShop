<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/admin\view\category_ad\list.htm";i:1559047113;s:80:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/admin\view\common\top.htm";i:1508129371;s:81:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/admin\view\common\left.htm";i:1561206852;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <tbody>
                            <?php if(is_array($cbRes) || $cbRes instanceof \think\Collection || $cbRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cbRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cb): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <?php switch($cb['position']): case "A": ?>左侧<?php break; case "B": ?>右上<?php break; case "C": ?>右下<?php break; endswitch; ?>
                                    </td>
                                    <td align="center"><?php if($cb['img_url']): ?> <img src="__uploads__/<?php echo $cb['img_url']; ?>" height="30"> <?php else: ?> 暂无推广图 <?php endif; ?></td>
                                    <td><a href="<?php echo $cb['link_url']; ?>" target="_blank"><?php echo $cb['link_url']; ?></a></td>
