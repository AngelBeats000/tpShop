<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/index\view\category\category.htm";i:1561471006;s:81:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/index\view\common\head.htm";i:1560412596;s:82:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/index\view\common\right.htm";i:1516076657;s:83:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/index\view\common\footer.htm";i:1559549771;}*/ ?>
<!doctype html>
<html>
<head>  
...
<div class="right-extra" rewrite=0>
    ...
    &nbsp;
        ...
        <?php 
            ...
            $filter = input('filter_attr');
            if(!$filter){
                $arr = array_fill(0,count($attrRes),0);
                $filter = implode('.', $arr);
            }
        ?>
	...
	<div class="goods_list">
		<ul class="attr_father">
            ...
            <li class="s-line">
                <dl class="s-l-wrap">
                    <div class="s-l-tit filter_attr_name">品牌：</div>
                    <div class="s-l-value attr_son">
                        <div class="price_auto fl">
                             <div class="price_range"><a <?php if(!input('brand')) echo 'class="btn sc-redBg-btn"'; ?>  href="<?php echo url('index/Category/index',array('id'=>input('id'), 'price'=>$price, 'filter_attr'=>$filter, 'ob'=>$ob, 'ow'=>$ow),''); ?>#search">不限</a></div>
                            <?php if(is_array($brandRes) || $brandRes instanceof \think\Collection || $brandRes instanceof \think\Paginator): $i = 0; $__LIST__ = $brandRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$brand): $mod = ($i % 2 );++$i;?>
                                <div class="price_range"><a <?php if(input('brand')==$brand['brand_name']) echo 'class="btn sc-redBg-btn"'; ?> href="<?php echo url('index/Category/index',array('id'=>input('id'),'brand'=>$brand['id'], 'price'=>$price, 'filter_attr'=>$filter, 'ob'=>$ob, 'ow'=>$ow),''); ?>#search"><?php echo $brand['brand_name']; ?></a></div>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
            ...
            <li class="s-line">
                <dl class="s-l-wrap">
                    ...
                    <div class="s-l-value attr_son">
                        <div class="price_auto fl">
                             <div class="price_range"><a <?php if(!input('price')) echo 'class="btn sc-redBg-btn"'; ?> href="<?php echo url('index/Category/index',['id'=>input('id'), 'price'=>$price, 'brand'=>$brand, 'filter_attr'=>$filter, 'ob'=>$ob, 'ow'=>$ow],''); ?>#search">不限</a></div>
                            <?php if(is_array($priceSection) || $priceSection instanceof \think\Collection || $priceSection instanceof \think\Paginator): $i = 0; $__LIST__ = $priceSection;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$price): $mod = ($i % 2 );++$i;?>
                                <div class="price_range"><a <?php if(input('price')==$price) echo 'class="btn sc-redBg-btn"'; ?>href="<?php echo url('index/Category/index',['id'=>input('id'),'price'=>$price, 'brand'=>$brand, 'filter_attr'=>$filter, 'ob'=>$ob, 'ow'=>$ow],''); ?>#search"><?php echo $price; ?></a></div>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                        <div class="price_auto price_bottom fl">
...
<button class="price_ok price_class">确定</button>
                ...
                <li class="s-line">
                    <dl class="s-1-wrap">
                        ...
                        <div class="s-1-value attr_son">
                            <div class="price_auto f1">
                                <!-- 交叉筛选 -->
                                    <?php 
                                        $tmp_attr_arr = $attr_arr;
                                        $tmp_attr_arr[$k] = 0;
                                        $_attr_str = implode('.', $tmp_attr_arr); //把['100G-1','红色-3','i7-5']  转换成字符串，用于发送的参数
                                        if($attr_arr[$k]){
                                            $temp = explode('-', $attr_arr[$k]);
                                            $_filter = $temp[0];
                                        }else{
                                            $_filter = '0';
                                        }
                                        echo $_filter;
                                    ?>
                                 <div class="price_range"><a <?php if($_filter == '0'): ?> class="btn sc-redBg-btn" <?php endif; ?> href="<?php echo url('index/Category/index', ['id'=>$cateId, 'filter_attr'=>$_attr_str, 'brand'=>$brand, 'price'=>$price, 'ob'=>$ob, 'ow'=>$ow], ''); ?>">不限</a></div>
                                 <?php 
                                    foreach($v['attr_values'] as $k1 => $v1): 
                                    $tmp_attr_arr = $attr_arr;
                                    $tmp_attr_arr[$k] = $v1['attr_value'] .'-'.$v['id'];
                                    $attr_str = implode('.',$tmp_attr_arr);


                                 ?>
                                    
                                <div class="price_range"><a <?php if($v1['attr_value'] == $_filter): ?> class="btn sc-redBg-btn" <?php endif; ?> href="<?php echo url('index/Category/index', ['id'=>$cateId, 'filter_attr'=>$attr_str, 'brand'=>$brand, 'price'=>$price, 'ob'=>$ob, 'ow'=>$ow], ''); ?>"><?php echo $v1['attr_value']; ?></a></div>
                                <?php endforeach; ?>
                            </div>
                            <div class="price_auto price_bottom fl">
                            </div>
    ...
    <div class="filter-sort">
        ...
        <?php if($ob == 'xl' && $ow == 'desc'): ?>
            <a href="<?php echo url('index/Category/index',['id'=>$cateId, 'ob'=>'xl', 'ow'=>'asc', 'brand'=>$brand, 'price'=>$price, 'filter_attr'=>$filter], ''); ?>#search" class="curr">销量<i class="iconfont icon-arrow-up"></i></a>
        <?php elseif($ob == 'xl' && $ow == 'asc'): ?> 
            <a href="<?php echo url('index/Category/index',['id'=>$cateId, 'ob'=>'xl', 'ow'=>'desc', 'brand'=>$brand, 'price'=>$price, 'filter_attr'=>$filter], ''); ?>#search" class="curr">销量<i class="iconfont icon-arrow-down"></i></a>
        <?php else: ?>
            <a href="<?php echo url('index/Category/index',['id'=>$cateId, 'ob'=>'xl', 'ow'=>'asc', 'brand'=>$brand, 'price'=>$price, 'filter_attr'=>$filter], ''); ?>#search" class="">销量<i class="iconfont icon-arrow-up"></i></a>
        <?php endif; if($ob == 'time' && $ow == 'desc'): ?>
            <a href="<?php echo url('index/Category/index',['id'=>$cateId, 'ob'=>'time', 'ow'=>'asc', 'brand'=>$brand, 'price'=>$price, 'filter_attr'=>$filter], ''); ?>#search" class="curr">新品<i class="iconfont icon-arrow-up"></i></a>
        <?php elseif($ob == 'time' && $ow == 'asc'): ?> 
            <a href="<?php echo url('index/Category/index',['id'=>$cateId, 'ob'=>'time', 'ow'=>'desc', 'brand'=>$brand, 'price'=>$price, 'filter_attr'=>$filter], ''); ?>#search" class="curr">新品<i class="iconfont icon-arrow-down"></i></a>
        <?php else: ?>
            <a href="<?php echo url('index/Category/index',['id'=>$cateId, 'ob'=>'time', 'ow'=>'asc', 'brand'=>$brand, 'price'=>$price, 'filter_attr'=>$filter], ''); ?>#search" class="">新品<i class="iconfont icon-arrow-up"></i></a>
        <?php endif; if($ob == 'pl' && $ow == 'desc'): ?>
            <a href="<?php echo url('index/Category/index',['id'=>$cateId, 'ob'=>'pl', 'ow'=>'asc', 'brand'=>$brand, 'price'=>$price, 'filter_attr'=>$filter], ''); ?>#search" class="curr">评论数<i class="iconfont icon-arrow-up"></i></a>
        <?php elseif($ob == 'pl' && $ow == 'asc'): ?> 
            <a href="<?php echo url('index/Category/index',['id'=>$cateId, 'ob'=>'pl', 'ow'=>'desc', 'brand'=>$brand, 'price'=>$price, 'filter_attr'=>$filter], ''); ?>#search" class="curr">评论数<i class="iconfont icon-arrow-down"></i></a>
        <?php else: ?>
            <a href="<?php echo url('index/Category/index',['id'=>$cateId, 'ob'=>'pl', 'ow'=>'asc', 'brand'=>$brand, 'price'=>$price, 'filter_attr'=>$filter], ''); ?>#search" class="">评论数<i class="iconfont icon-arrow-up"></i></a>
        <?php endif; if($ob == 'shop_price' && $ow == 'desc'): ?>
            <a href="<?php echo url('index/Category/index',['id'=>$cateId, 'ob'=>'shop_price', 'ow'=>'asc', 'brand'=>$brand, 'price'=>$price, 'filter_attr'=>$filter], ''); ?>#search" class="curr">价格<i class="iconfont icon-arrow-up"></i></a>
        <?php elseif($ob == 'shop_price' && $ow == 'asc'): ?> 
            <a href="<?php echo url('index/Category/index',['id'=>$cateId, 'ob'=>'shop_price', 'ow'=>'desc', 'brand'=>$brand, 'price'=>$price, 'filter_attr'=>$filter], ''); ?>#search" class="curr">价格<i class="iconfont icon-arrow-down"></i></a>
        <?php else: ?>
            <a href="<?php echo url('index/Category/index',['id'=>$cateId, 'ob'=>'shop_price', 'ow'=>'asc', 'brand'=>$brand, 'price'=>$price, 'filter_attr'=>$filter], ''); ?>#search" class="">价格<i class="iconfont icon-arrow-up"></i></a>
        <?php endif; ?>
...
<ul>
            <li  class="curr"><img src="__uploads__/<?php echo $goods['sm_thumb']; ?>" width="26" height="26" /></li>
            <?php if(!empty($goods['mid_photo'])): 
                    $sm=explode(',',$goods['mid_photo']);
                    foreach($sm as $v):
                ?>
                <li  class="curr"> <img src="__uploads__/<?php echo $v; ?>"  width="26" height="26"></li>
...
<a href="#" class="sider-next"><i class="iconfont icon-right"></i></a>
                    ...
                    <div class="p-lie">
<div class="p-price">
            <em>¥</em><?php echo $goods['shop_price']; ?>    </div>
<div class="p-num">已售<em><?php echo $goods['xl']; ?></em>件    评论<em><?php echo $goods['pl']; ?></em>条</div>
                        </div>
                    ...
                    <div class="p-activity">
                            ...
                            if($goods['recpos']){
                               ...
                               $recposArr = explode(',',$goods['recpos']);
                            
                                if(in_array(3,$recposArr)){
                                    echo '<span class="tag tac-mn"><i class="i-left"></i>新品<i class="i-right"></i></span>';
                                }
                                if(in_array(2,$recposArr)){
                                        echo '<span class="tag tac-mh"><i class="i-left"></i>热卖<i class="i-right"></i></span>';
                                }
                                if(in_array(4,$recposArr)){
                                        echo '<span class="tag tac-mb"><i class="i-left"></i>精品<i class="i-right"></i></span>';
                                }
                                if(in_array(7,$recposArr)){
                                        echo '<span class="tag tac-sr"><i class="i-left"></i>自营<i class="i-right"></i></span>';
                                }
                            }?>
