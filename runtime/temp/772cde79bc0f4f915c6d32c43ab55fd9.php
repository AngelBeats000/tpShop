<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/index\view\flow\flow2.htm";i:1560864905;s:83:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/index\view\common\footer.htm";i:1559549771;}*/ ?>
...
<div class="ck-step" id="consignee_list">
    ...
    <div class="form-row">
        ...
        <div class="form-value"><input type="text" name="consignee" value="<?php echo $uAdress['name']; ?>" value="" class="form-input"><div class="form_prompt"></div></div>
    </div>
    <div class="form-row">
        <div class="form-label"><span class="red">*</span>手机号码：</div>
        <div class="form-value">
            <input type="text" name="mobile" value="<?php echo $uAdress['phone']; ?>" class="form-input">
    ...
    <script type="text/javascript">
        _init_area();
        $('select[name="province"]').val("<?php echo $uAdress['province']; ?>");
        $('select[name="province"]').change();
        $('select[name="city"]').val("<?php echo $uAdress['city']; ?>");    
        $('select[name="city"]').change();
        $('select[name="county"]').val("<?php echo $uAdress['county']; ?>");
...
Gid('s_county').setAttribute('onchange','showArea()');
    ...
    <div class="form-row">
        ...
        <div class="form-value"><input type="text" name="address" value="<?php echo $uAdress['adress']; ?>" class="form-input form-input-long"><div class="form_prompt"></div></div>
    </div>
    <div class="form-row">
    ...
    <div class="form-row">
        <div class="form-label"><span class="red">&nbsp;&nbsp;</span>发货时间：</div>
        ...
        <div class="payment-warp">
            <div class="payment-list" ectype="paymentType">
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
                    <span>
                        <input type="radio" checked="checked" value="1" name="payment" />支付宝     
                    </span>
                    <b></b>
                </div>
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
    ...
    <div class="ck-step-cont">
        <div class="payment-warp">
            <div class="payment-list" ectype="paymentType">
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
                    <span>
                        <input type="radio" checked="checked" name="distribution" />申通     
                    </span>
                    <b></b>
                </div>
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
                    <span>
                        <input type="radio" name="distribution" />圆通    
                    </span>
                    <b></b>
                </div>
            </div>
...
<a href="javascript:;" id="IM" onclick="openWin(this)" ru_id="0" class="p-kefu  p-c-violet" target="_blank"><i class="iconfont icon-kefu"></i></a>
        ...
        <div class="ck-goods-cont">
            <?php
                $goodsNum = 0;
                $memberPrice = 0;
            if(is_array($cartGoodsArr) || $cartGoodsArr instanceof \think\Collection || $cartGoodsArr instanceof \think\Paginator): $i = 0; $__LIST__ = $cartGoodsArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;
                    $goodsNum += $vo['number'];
                    $memberPrice += $vo['shop_price'] * $vo['number'];
                ?>
            <div class="cg-item">
<div class="c-col cg-name">
            <input name="cart_info[]" type="hidden" value="0|37_843_2_1">
            <a href="goods.php?id=843" target="_blank">
        <div class="p-img"><img src="__uploads__/<?php echo $vo['sm_thumb']; ?>" width="48" height="48"></div>
        <div class="p-info">
            <div class="p-name"><?php echo $vo['goods_name']; ?></div>
            <div class="p-attr"><?php echo $vo['goodsStr']; ?></div>
        </div>
    </a>
    </div>
<div class="c-col cg-price">
    <span class="fr cl"><em>¥</em><?php echo $vo['shop_price']; ?></span>
    </div>
<div class="c-col cg-number">x<?php echo $vo['number']; ?></div>
...
<div class="c-col cg-sum"><em>¥</em><?php echo $vo['shop_price'] * $vo['number']; ?></div>
...
<div class="order-summary">
    <div class="statistic">
        <div class="list">
            ...
            <em class="price" id="warePriceId"><em>¥</em><?php echo $memberPrice; ?></em>
        </div>
<div class="list">
            <span>应付总额：</span>
...
<div class="checkout-foot" ectype="tfoot-toolbar">
    ...
    <input type="hidden" name="cart_value" value="<?php echo $doGoods; ?>">
