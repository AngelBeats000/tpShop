<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/admin\view\category_brands\list.htm";i:1516525413;s:80:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/admin\view\common\top.htm";i:1508129371;s:81:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/admin\view\common\left.htm";i:1561206852;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加链接" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('CategoryBrands/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if(is_array($cbRes) || $cbRes instanceof \think\Collection || $cbRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cbRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cb): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    <td align="center"><?php echo $cb['id']; ?></td>
                                    <td align="center"><?php if($cb['brand_name']): ?> <?php echo $cb['brand_name']; else: ?> 暂无关联品牌 <?php endif; ?></td>
                                    <td align="center"><?php if($cb['pro_img']): ?> <img src="__uploads__/<?php echo $cb['pro_img']; ?>" height="30"> <?php else: ?> 暂无推广图 <?php endif; ?></td>
                                    <td><a href="<?php echo $cb['pro_url']; ?>" target="_blank"><?php echo $cb['pro_url']; ?></a></td>
                                    <td align="center">
                                        <?php echo $cb['cate_name']; ?>
                                    </td>
                                    <td align="center">
                                        <a href="<?php echo url('edit',array('id'=>$cb['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$cb['id'])); ?>')" class="btn btn-danger btn-sm shiny">
