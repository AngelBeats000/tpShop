...
</script><link rel="stylesheet" type="text/css" href="__index__/js/perfect-scrollbar/perfect-scrollbar.min.css" />
</head>
            ...
            <div class="payOrder-warp" id="pay_main">
                <div class="payOrder-desc">
                    <div class="pay-top">
                        ...
                        <div class="pay-total">
                            <span>应付总额：</span>
                            <div class="pay-price">￥<?php echo $ordRes['order_total_price']; ?></div>
                        </div>
                    </div>
                    <div class="pay-txt">
                        <p>订单号：<em id="nku"><?php echo $ordRes['out_trade_no']; ?></em></p>
                        <p>您选定的支付方式为：<span id="paymode"><?php echo $ordRes['payment']; ?></span></p>
            	                    <p>配送方式: <span id="express"><?php echo $ordRes['distribution']; ?></span></p>
                            </div>
    <div class="o-list">
                        <div class="o-list-info">
                            <span id="shdz">寄送至：<?php echo $ordRes['province']; ?>  <?php echo $ordRes['city']; ?>  <?php echo $ordRes['county']; ?>  &nbsp;&nbsp;<?php echo $ordRes['address']; ?></span>
                            <span id="shr">收货人：<?php echo $ordRes['name']; ?></span>
