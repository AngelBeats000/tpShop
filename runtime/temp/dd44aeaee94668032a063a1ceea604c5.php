...
<div class="preview" if="preview">
	<div class="gallery_wrap"><a href="__uploads__/<?php echo $goodsInfo['big_thumb']; ?>" class="MagicZoomPlus" id="Zoomer" rel="hint-text: ; selectors-effect: false; selectors-class: img-hover; selectors-change: mouseover; zoom-distance: 10;zoom-width: 400; zoom-height: 474;"><img src="__uploads__/<?php echo $goodsInfo['mid_thumb']; ?>" id="J_prodImg" alt="<?php echo $goodsInfo['goods_name']; ?>"></a></div>
	<div class="spec-list">
		<a href="javascript:void(0);" class="spec-prev"><i class="iconfont icon-left"></i></a>
		<div class="spec-items">
			<ul>
            <?php if(is_array($goodsPhoto) || $goodsPhoto instanceof \think\Collection || $goodsPhoto instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsPhoto;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$photo): $mod = ($i % 2 );++$i;?>	            	 
            <li>
					<a href="__uploads__/<?php echo $photo['big_photo']; ?>" rel="zoom-id: Zoomer" rev="__uploads__/<?php echo $photo['mid_photo']; ?>" class="img-hover">
<img src="__uploads__/<?php echo $photo['sm_photo']; ?>" alt="韩美格2017春秋新款修身大码蕾丝网纱打底衫女长袖薄款圆领女T恤 全店商品 二件减5元 三件减10" width="58" height="58" />
					</a>
				</li>
			<?php endforeach; endif; else: echo "" ;endif; ?>
...
<script type="text/javascript">
	document.getElementById("bdshell_js").src = "https://test.dscmall.cn/static/ap__index__/js/share.js?v=89860593.js?cdnversion=" + new Date().getHours();
</script>
<script type="text/javascript">
$(function(){
	get_collection();
...
<div class="si-warp">
    <strong class="shop-price" id="ECS_SHOPPRICE" ectype="SHOP_PRICE"><em>¥</em><?php echo $goodsInfo['shop_price']; ?></strong>
    <span class="price-notify" data-userid="62" data-goodsid="799" ectype="priceNotify">降价通知</span>
</div>
<script type="text/javascript">
	//商品价格
	var goods_id=<?php echo $goodsInfo['id']; ?>;
	var shop_price=<?php echo $goodsInfo['shop_price']; ?>;
	var new_shop=shop_price;
	$.ajax({
		type:'post',
		dataType:'json',
		url:"<?php echo url('index/Goods/ajaxGetMemberPrice'); ?>",
		data:{goods_id:goods_id,shop_price:shop_price},
		success:function(data){
			new_shop=data;
			var html='<em>¥</em>'+data;
			$("#ECS_SHOPPRICE").html(html);
		}
	});
</script>
                </div>
...
<div class="store-warehouse">
    ...
    <div id="isHas_warehouse_num" class="store-prompt"></div>
            ...
            <!-- 单选开始 -->
            	<?php if(is_array($radioAttrArr) || $radioAttrArr instanceof \think\Collection || $radioAttrArr instanceof \think\Paginator): $i = 0; $__LIST__ = $radioAttrArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
          		<div class="summary-item is-integral">
                    <div class="si-tit"><?php echo $key; ?></div>
                    <div class="si-warp">
                        ...
                        <label  price="<?php echo $vo1['attr_price']; ?>" <?php if($i == 1): ?> class="checkstatus" <?php endif; ?>><input <?php if($i == 1): ?> checked="checked" <?php endif; ?> type="radio" name="attr_<?php echo $vo1['attr_id']; ?>" value="<?php echo $vo1['id']; ?>"><?php echo $vo1['attr_value']; ?><i></i></label>
                      		<?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            <!-- 单选结束 -->
                <script type="text/javascript">
                	...
                	var goods_attr_ids=goods_attr.toString();
                </script>
...
<div class="qrcode_pop">
    <div class="mobile-qrcode"><img src="__index__/img/weixin_code_799.png" alt="商品二维码" title="" width="175"></div>
</div>
                </div>
            </div>
		        	<div class="inner">
...
<div class="gm-floors" ectype="gm-floors">
    <div class="gm-f-item gm-f-details" ectype="gm-item">
        ...
        <div class="goods-para-list">
            <dl class="goods-para">
            	<?php if(is_array($uniAttrArr) || $uniAttrArr instanceof \think\Collection || $uniAttrArr instanceof \think\Paginator): $i = 0; $__LIST__ = $uniAttrArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
...
<script type="text/javascript" src="__index__/js/warehouse.js"></script><script type="text/javascript" src="__index__/js/warehouse_area.js"></script>
    ...
    //动态计算不同属性商品价格
    function jqueryPrice(){
    	var price = new_shop;
    	$(".checkstatus").each(function(){
        	price=Number(price) + Number($(this).attr('price'));
        });
        $("#ECS_SHOPPRICE").html(price);
    }
