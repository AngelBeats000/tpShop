<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/member\view\account\getpassword.htm";i:1559616573;}*/ ?>
...
<div class="get_pwd">
    <div class="loginRegister-header">
        <div class="w w1200">
            <div class="logo">
                <div class="logoImg"><a href="<?php echo url('index/Index/ndex'); ?>" class="logo"><img src="__index__/user_login_logo.png" /></a></div>
                <div class="logo-span">
                    <b style="background:url(__index__/login_logo_pic.png) no-repeat;"></b>                </div>
            </div>
                    ...
                    <div class="form form-other" ectype="formWarp">
                        ...
                        <div class="gp-content" ectype="gpContent">
                            <div class="gp-warp formPhone" style="display:block;">
                                <form action="<?php echo url('member/Account/checkPhoneCode'); ?>" method="post" name="getPhonePassword" ectype="form">
                                    <div class="item">
