<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\phpstudy\PHPTutorial\WWW\shop\public/../application/index\view\flow\paysuccess.htm";i:1560864754;}*/ ?>
...
//加载效果
var load_cart_info = '<img src="__index__/img/load/loadGoods.gif" class="load" />';
...
<div class="header header-cart">
                    ...
                    <div class="s-i-right">
                        ...
                        <div class="s-i-tit">
                            <p>订单号：<em id="nku"><?php echo $orderInfo['out_trade_no']; ?></em></p>
                                                                                    <p>配送方式：<em><?php echo $orderInfo['distribution']; ?></em></p>
                            <p>运费：<em><em>¥</em>0</em></p>
                                                        <p>应付总金额：<em><em>¥</em><?php echo $orderInfo['order_total_price']; ?></em></p>
                            <p>收货人：<span id="username"><?php echo $orderInfo['name']; ?></span><span id="tel" class="ml20"><?php echo $orderInfo['phone']; ?></span></p>
                            <p>寄送至： <span id="address"><?php echo $orderInfo['province']; ?> <?php echo $orderInfo['city']; ?> <?php echo $orderInfo['county']; ?>&nbsp;<?php echo $orderInfo['address']; ?></span></p>
                                                    </div>
                                                <div class="s-i-btn">
        ...
        <li><a href="article.php?id=18"  title="资金管理" target="_blank">资金管理</a></li>
            ...
            <div class="qr-code">
                <div class="qr-item qr-item-first">
                    <div class="code_img"><img src="img/common/ecjia_qrcode.png"></div>
                    <div class="code_txt">ECJia</div>
                </div>
                <div class="qr-item">
                    <div class="code_img"><img src="img/common/ectouch_qrcode.png"></div>
            ...
            <p class="copyright_links">
                ...
                <a href="http://www.ecmoban.com" target="_blank" title="模板堂">模板堂</a>
                    ...
                    <a href="http://help.ecmoban.com" target="_blank" title="电商学院">电商学院</a>
                        ...
                        <p><span>©&nbsp;2015-2018&nbsp;dscmall.cn&nbsp;版权所有&nbsp;&nbsp;</span><span>ICP备案证书号:</span><a href="http://www.miibeian.gov.cn/" target="_blank">DSC00000123</a>&nbsp;POWERED by<a href="http://www.dscmall.cn/" target="_blank">大商创</a>2.0</p>
    ...
    <div class="hidden">
        ...
        <input type="hidden" name="user_id" ectype="user_id" value="88" />
    </div>
</div>
